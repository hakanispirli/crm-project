...
@section('dashboard')
    ...
    <div x-data="urunlerTablo">
        <div class="panel mt-6 justify-content-between">
            <h4 class="mb-5 text-lg font-semibold dark:text-white-light md:absolute md:top-[25px] md:mb-0">
                Ürünler</h4>
            <table id="urunler" class="whitespace-nowrap"></table>
            <div class="flex justify-end mt-5" style="padding-right: 50px;">
                <a href="{{ route('fiyatlandirma') }}" class="btn btn-lg btn-primary">İleri</a>
            </div>
        </div>
    </div>
