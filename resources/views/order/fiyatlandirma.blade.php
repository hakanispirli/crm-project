...
@section('dashboard')
    <div class="mb-5 mt-5">
        <div class="inline-block w-full">
            <ul class="mb-5 grid grid-cols-3">
                <li>
                    <a href="{{ route('orders') }}" class="text-primary">
    ...
    <div class="mb-5 grid grid-cols-3 gap-5">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="pro-price">Alış Fiyatı</th>
                            <th class="pro-price">Satılan Ürün Adedi</th>
                            <th class="pro-price">İşlem</th>
                        </tr>
                    </thead>
                    <tbody id="cartPage">
        ...
        <div class="panel col-span-3 lg:col-span-1">
            ...
            <div id="totalPriceContainer" class="mb-5">
            ...
            <div class="flex justify-end mt-5">
                <a href="{{ route('siparis.olustur') }}" type="button" class="btn btn-lg btn-primary">İleri</a>
            </div>
        </div>
    </div>
@endsection
