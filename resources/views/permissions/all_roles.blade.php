        ...
        <div class="panel mt-6">
            <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                <div class="mb-5 flex flex-wrap items-center">
                    ...
                    <div x-data="modal">
                        <button type="button" class="btn btn-danger" @click="toggle">Rol Ekle</button>
                                    ...
                                    <div class="p-5">
                                        <form id="addRole">
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <input type="text" name="name" placeholder="Rol Adı"
        ...
        Alpine.data('exportTable', () => ({
                ...
                fetch('{{ url('/get/role') }}')
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            console.error('Rol verileri alınamadı.');
                        }
                    })
                .catch(error => {
            ...
            renderTable() {
                const rows = this.role.map(role => {
                    const editRoleUrl = "{{ url('/edit/roles') }}";
                    const editRoleUrlWithId = `${editRoleUrl}/${role.id}`;
                    const roleId = role.id;
                    return [
                        role.id,
                        role.name,
                        `<div class="flex">
                            <a href="${editRoleUrlWithId}" class="btn btn-sm btn-outline-primary mr-2">
                                Düzenle
                            </a>
                            <a onclick="deleteRole(${roleId})" class="btn btn-sm btn-outline-danger">
                                Sil
                            </a>
                        </div>`
                    ];
