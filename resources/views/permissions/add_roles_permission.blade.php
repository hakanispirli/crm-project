@extends('master')
@section('dashboard')
    <div class="mb-5 grid grid-cols-2 gap-5 lg:grid-cols-3 xl:grid-cols-4">
        <div class="panel">
        ...
        <div class="panel lg:col-span-1 xl:col-span-3">
            <form action="{{ route('role.permission.store') }}" method="POST" class="space-y-5">
                @csrf
                <div class="flex sm:flex-row flex-col">
                    <label for="horizontalEmail" class="mb-1 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Yönetici Rolü</label>
                    <select name="role_id" class="form-select text-white-dark flex-1">
                        <option selected="" disabled>Lütfen bir rol seçimi yapın</option>
                ...
                <div class="flex sm:flex-row flex-col">
                    <label class="mb-4 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Menü İzinler</label>
                    <div class="lg:w-1/2">
                        @foreach ($permission_groups as $group)
                            <div class="flex flex-wrap">
                                <div class="lg:w-1/2 mb-4 sm:mb-1">
                                    <div class="checkbox-custom checkbox-default">
                                        <label class="inline-flex mb-3 cursor-pointer">
                                            <input type="checkbox" class="form-checkbox flex-1"
                                                id="checkbox{{ $group->group_name }}" />
                                ...
                                <div class="lg:w-1/2 mb-4 sm:mb-1">
                                    ...
                                    @foreach ($permissions as $permission)
                                        <div class="checkbox-custom checkbox-default">
                                            <label class="inline-flex mb-3 cursor-pointer">
                                                <input type="checkbox" class="form-checkbox flex-1"
                                                    id="checkbox{{ $permission->id }}" name="permission[]"
                                                    value="{{ $permission->id }}">
