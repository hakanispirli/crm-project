...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased">
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
            <div
                class="ppx-6 py-16 text-center font-semibold before:container
                ...
                <div class="relative">
                    <img src="assets/images/error/500-light.svg"
                        class="mx-auto -mt-10 w-full max-w-xs object-cover md:-mt-14 md:max-w-xl" />
                    <p class="mt-5 text-base dark:text-white">Sunucu Hatası!</p>
                    <a href="{{ route('dashboard') }}"
                        class="btn btn-gradient mx-auto !mt-7
                        w-max border-0 uppercase shadow-none">Kontrol
                        Paneli</a>
                </div>
            </div>
        </div>
