        ...
        bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
            <div class="relative">
                <div class="flex flex-col items-center justify-center sm:-ms-32 sm:flex-row xl:-ms-60">
                    <div class="mb-2 text-center text-2xl font-bold dark:text-white md:text-5xl">Ödemeniz Alınamadı!</div>
                </div>
                <p class="mb-9 mt-5 text-center text-base font-semibold">
                    Ödeme İşlemi Sırasında Bir Hata Oluştu. Lütfen WhatsApp Destek Hattından Bizimle İletişime Geçin!
                </p>
            </div>
        </div>
