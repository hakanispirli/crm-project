...
<head>
    ...
    <title>Login - Tattoo Crm System</title>
    ...
    <link href="{{ asset('assets/css/perfect-scrollbar.min.css') }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ asset('assets/css/style.css') }}" rel="stylesheet" type="text/css" media="screen" />
    <link defer href="{{ asset('assets/css/animate.css') }}" rel="stylesheet" type="text/css" media="screen" />
                    ...
                    <div
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="#" class="block w-48 lg:w-72 ms-10">
                                <img src="assets/images/auth/login_logo.png" alt="Logo" class="w-full" />
                            </a>
                            <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src="assets/images/auth/login_page_1.png" alt="Cover Image" class="w-full" />
                            </div>
                        </div>
                    </div>
                    <div
                        class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6
                        sm:px-6 lg:max-w-[667px]">
                        <div class="w-full max-w-[440px] lg:mt-16">
                            <div class="mb-10">
                                ...
                                <p class="text-base font-bold leading-normal text-white-dark">
                                    Lütfen kullanıcı adı veya email adresiniz ile şifrenizi giriniz.
                                </p>
                            </div>
                            ...
                            <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input id="Email" type="email" name="email" placeholder="Email veya Kullanıcı Adı"
                            ...
                            <div class="relative my-7 text-center md:mb-9">
                                ...
                                <span
                                    class="relative bg-white px-2 font-bold uppercase text-white-dark dark:bg-dark dark:text-white-light">CRM Panel</span>
                            </div>
                        </div>
                        <p class="absolute bottom-6 w-full text-center dark:text-white">
                            © <span id="footer-year">2024</span>. WebMarka All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
