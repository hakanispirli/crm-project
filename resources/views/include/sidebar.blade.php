    ...
    <nav x-data="sidebar"
        ...
        <div class="h-full bg-white dark:bg-[#0e1726]">
            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard') }}" class="group">
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Kontrol Paneli</span>
                        </div>
                    </a>
                </li>
                @if (Auth::user()->can('notlar.menu'))
                <li class="nav-item">
                    <a href="{{ route('all.notes') }}" class="group">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Notlar</span>
                        </div>
                    </a>
                </li>
                @endif
                ...
                <li class="nav-item">
                    <a href="{{ route('api.appointments.view') }}" class="group">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Randevular</span>
                        </div>
                    </a>
                </li>
                @endif
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'kayit'}" @click="activeDropdown === 'kayit' ? activeDropdown = null : activeDropdown = 'kayit'">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Kayıt İşlemleri</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'kayit'}">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </div>
                    </button>
                    <ul x-show="activeDropdown === 'kayit'" x-collapse="" class="sub-menu text-gray-500" style="height: 0px; overflow: hidden; display: none;" hidden="">
                ...
                <li class="nav-item">
                    <a href="{{ route('products') }}" class="group">
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Ürünler</span>
                        </div>
                    </a>
                </li>
                @endif
                ...
                <li class="nav-item">
                    <a href="{{ route('orders') }}" class="group">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Satış</span>
                        </div>
                    </a>
                </li>
                @endif
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'invoice'}" @click="activeDropdown === 'invoice' ? activeDropdown = null : activeDropdown = 'invoice'">
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Sms İşlemleri</span>
                        </div>
                    ...
                    <ul x-show="activeDropdown === 'invoice'" x-collapse="" class="sub-menu text-gray-500" style="height: 0px; overflow: hidden; display: none;" hidden="">
                        ...
                        <li>
                            <a href="{{ route('sms.template') }}">Sms Şablonları</a>
                        </li>
                    </ul>
                </li>
                @endif
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'kayit'}" @click="activeDropdown === 'kayit' ? activeDropdown = null : activeDropdown = 'kayit'">
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Yönetici İşlemleri</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'kayit'}">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                @endif
                <li class="menu nav-item">
                    <a href="{{ route('admin.logout') }}" target="_blank" class="nav-link group">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Çıkış</span>
                        </div>
                    </a>
                </li>
            </ul>
